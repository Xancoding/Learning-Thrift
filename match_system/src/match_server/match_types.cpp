...
void User::__set_scores(const int32_t val) {
  this->scores = val;
}
...
uint32_t User::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          xfer += iprot->readI32(this->scores);
...
uint32_t User::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("scores", ::apache::thrift::protocol::T_I32, 3);
  xfer += oprot->writeI32(this->scores);
  xfer += oprot->writeFieldEnd();
...
User::User(const User& other0) {
  id = other0.id;
  name = other0.name;
  scores = other0.scores;
  __isset = other0.__isset;
}
User& User::operator=(const User& other1) {
  id = other1.id;
  name = other1.name;
  scores = other1.scores;
